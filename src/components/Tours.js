...
<div className="section-center featured-center">
  ...
  <article className="tour-card">
    <div className="tour-img-container">
      <img src={tour5} className="tour-img" alt="africa highlights" />
      <p className="tour-date">december 20th, 2020</p>
    </div>
    <div className="tour-info">
      <div className="tour-title"><h4>Africa highlights</h4></div>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        Cumque vitae tempore voluptatum maxime reprehenderit eum quod
        exercitationem fugit, qui corporis.
      ...
      <div className="tour-footer">
        <p>
          <span><i className="fas fa-map"></i></span>Africa
        </p>
        <p>from $2900</p>
        <p>15 days</p>
      </div>
  ...
  <article className="tour-card">
    <div className="tour-img-container">
      <img src={tour6} className="tour-img" alt="tajmahal highlights" />
      <p className="tour-date">december 20th, 2020</p>
    </div>
    <div className="tour-info">
      <div className="tour-title"><h4>Taj Mahal highlights</h4></div>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit.
        Cumque vitae tempore voluptatum maxime reprehenderit eum quod
        exercitationem fugit, qui corporis.
      ...
      <div className="tour-footer">
        <p>
          <span><i className="fas fa-map"></i></span>India
        </p>
        <p>from $2100</p>
        <p>10 days</p>
      </div>
